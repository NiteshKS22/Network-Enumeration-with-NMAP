...
it's widely used query and response designed to access db that store info. about registered internet resources. 

primarily associated with domain names, WHOIS can also give details about IP address block and autonomous systems.

```
NiteshKS22@htb[/htb]$ whois inlanefreight.com
