...
```
NiteshKS22@htb[/htb]$ sudo nmap -sU --script ipmi-version -p 623 ilo.inlanfreight.local
...
YOU will get username:Hash-Password

**2.  What is the account's cleartext password?**

```
u have gotten password in hash


hashcat -m 7300 -a 0 hashpass.txt rockyou.txt
